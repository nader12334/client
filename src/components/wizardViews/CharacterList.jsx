...
useEffect(() => {
  ...
  return (
    <div id="characterSelect">
      ...
      <strong>Character List:</strong><br/>
      {characters.map((n) => {
        return (
    ...
    }}>Delete Character</button><br/><br/>
    </div><br/><br/>
      <div className="characterListSection">
        <strong>Start a new Character:</strong><br/>
        <button className="submitCharacterButton" onClick={(e) => {
          e.preventDefault();
        ...
        }}>Start New Character</button><br/><br/>
      </div>
    </div>
  )
};
